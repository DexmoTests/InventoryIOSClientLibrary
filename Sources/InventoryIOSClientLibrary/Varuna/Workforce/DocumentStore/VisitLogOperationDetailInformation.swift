...
public class VisitLogOperationDetailInformation: DocumentProtocol {
    public var VisitLogId: String?
    public var Operations: DocumentDetailElementCollection<Operation>?
