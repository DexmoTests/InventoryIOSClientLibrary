...
public class Route: DocumentProtocol {
    public var Locations: DocumentDetailElementCollection<RouteLocation>?
    public var DynamicFields: DocumentDetailElementCollection<RouteDynamicField>?
