...
public class PersonRoute: DocumentProtocol {
    public var FinishDate: Date?
    public var StartDate: Date?
    public var PersonId: String?
    public var VisitFrequency: String?
    public var Person: Person?
    public var Locations: DocumentDetailElementCollection<PersonRouteLocation>?
    public var DynamicFields: DocumentDetailElementCollection<PersonRouteDynamicField>?
