...
public class DynamicFormResource: DocumentProtocol {
    public var DynamicFormID: String?
    public var DynamicForm: DynamicForm?
    public var Resources: DocumentDetailElementCollection<DynamicFormResourceItem>?
