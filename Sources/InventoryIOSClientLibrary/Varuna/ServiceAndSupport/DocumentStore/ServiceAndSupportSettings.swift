...
public class ServiceAndSupportSettings: DocumentProtocol {
    public var ServiceRequestEmailTemplateId: String?
    public var ServiceOrderEmailTemplateId: String?
    public var ServiceOrderEmailTemplate: EmailTemplates?
    public var ServiceRequestEmailTemplate: EmailTemplates?
