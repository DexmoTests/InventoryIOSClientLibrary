...
public class Labor: DocumentProtocol {
    public var Status: EState?
    public var Code: String?
    public var Name: String?
    public var Explanation: String?
    public var LaborGroupId: String?
    public var LaborSubGroupId: String?
    public var LaborGroup: LaborGroup?
    public var LaborSubGroup: LaborSubGroup?
    public var LaborProductGroups: DocumentDetailElementCollection<LaborProductGroups>?
    public var DynamicFields: DocumentDetailElementCollection<LaborDynamicField>?
