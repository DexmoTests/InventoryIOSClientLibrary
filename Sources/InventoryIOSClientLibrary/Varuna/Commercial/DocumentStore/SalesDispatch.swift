...
public class SalesDispatch: DocumentProtocol {
    ...
    public var DynamicFields: DocumentDetailElementCollection<SalesDispatchDynamicField>?
    public var Lines: DocumentDetailElementCollection<SalesDispatchLine>?
    public var AdditionalTaxTotals: DocumentDetailElementCollection<AdditionalTaxAmountOnSalesDispatch>?
