...
public class CashCollection: DocumentProtocol {
    ...
    public var WorkedCurrenciesInfos: DocumentDetailElementCollection<CashCollectionWorkedCurrencyInfo>?
    public var DynamicFields: DocumentDetailElementCollection<CashCollectionDynamicField>?
