...
public class OrganizationSettings: DocumentProtocol {
    public var MultipleCurrencySelectionAvailable: Bool?
    public var AcceptableCurrencies: DocumentDetailElementCollection<AcceptableCurrency>?
