...
public class Territory: DocumentProtocol {
    public var Status: EState?
    public var Currency: ECurrencyIsoCode?
    public var Name: String?
    public var ParentTerritoryId: String?
    public var ParentTerritory: Territory?
    public var DynamicFields: DocumentDetailElementCollection<TerritoryDynamicField>?
