...
public class Serial: DocumentProtocol {
    public var StockId: String?
    public var Code: String?
    public var Stock: Stock?
    public var Transactions: DocumentDetailElementCollection<SerialTransaction>?
    public var DynamicFields: DocumentDetailElementCollection<SerialDynamicField>?
