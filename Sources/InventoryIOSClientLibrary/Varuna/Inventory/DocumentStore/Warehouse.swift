...
public class Warehouse: DocumentProtocol {
    public var CoordinatInfo: Geolocation?
    public var WarehouseType: EWarehouseType?
    ...
    public var DynamicFields: DocumentDetailElementCollection<WarehouseDynamicField>?
